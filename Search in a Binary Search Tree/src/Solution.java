...
public class Solution {
    /**
     * The problem is easy but one thing I missed: Binary Search Tree!!!
     *
     * The solution is to compare the root.val to val, if it is smaller, go to left else go to right.
     * 
     * @param root
     * @param val
     * @return
