...
public class Solution {
    ...
    /**
     * This is similar to (largest sum of non-adjacent numbers).
     *
     * See the explanation in SolutionExplained.java
     *
     * @param nums
     * @return
     */
    public int rob(int[] nums) {
        ...
        for(int i = 0; i < nums.length; i++) {
            int currentInclude = nums[i] + exclude;
            int currentExclude = Math.max(include, exclude);
